...
export const Introduction = () => {
  return (
    <div className="flex flex-col gap-10">
      <h4 className="text-4xl font-semibold">{DocsConstants.INTRODUCTION}</h4>
      <div className="flex flex-col gap-4">
        <h4 className="text-2xl text-gray-200">{DocsConstants.WORK}</h4>
      ...
      <div className="flex flex-col gap-4">
        <h4 className="text-2xl text-gray-200">{DocsConstants.GAMING}</h4>
        <span className="text-lg text-gray-400">
      ...
      <div className="flex flex-col gap-4">
        <h4 className="text-2xl text-gray-200">{DocsConstants.EDUCATION}</h4>
        <span className="text-lg text-gray-400">
      ...
      <div className="flex flex-col gap-4">
        <h4 className="text-2xl text-gray-200">{DocsConstants.GLITTER}</h4>
        <span className="text-lg text-gray-400">
      ...
      <div className="flex flex-col gap-4">
        <h4 className="text-2xl text-gray-200">{DocsConstants.SHUTTLE}</h4>
        <span className="text-lg text-gray-400">
