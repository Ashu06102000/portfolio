...
export const SkillsTab = () => {
  ...
  return (
    <div className="flex flex-col md:gap-10 gap-6">
      <h4 className="md:text-4xl text-2xl font-semibold">{DocsConstants.SKILLS}</h4>

      <div className="flex flex-col gap-4">
        <span className="text-gray-400 md:text-2xl text-xl">
        ...
        <div className="flex flex-col md:gap-2 gap-4">
          <div className="flex md:flex-row flex-col gap-2">
            ...
            {languages.map((ln) => {
              return (
                <span className="text-gray-400 md:px-1.5" key={ln}>
                  {ln}
                </span>
              );
            })}
          ...
          <div className="flex md:flex-row flex-col gap-2">
            ...
            {framework.map((framework) => {
              return (
                <span className="text-gray-400 md:px-1.5" key={framework}>
                  {framework}
                </span>
              );
            })}
          ...
          <div className="flex md:flex-row flex-col gap-2">
            ...
            {website.map((website) => {
              return (
                <span className="text-gray-400 md:px-1.5" key={website}>
                  {website}
                </span>
              );
            })}
          ...
          <div className="flex md:flex-row flex-col gap-2">
            ...
            {database.map((database) => {
              return (
                <span className="text-gray-400 md:px-1.5" key={database}>
                  {database} 
                </span>
              );
            })}
          ...
          <div className="flex md:flex-row flex-col gap-2">
            ...
            {testing.map((testing) => {
              return (
                <span className="text-gray-400 md:px-1.5" key={testing}>
                  {testing}
                </span>
              );
            })}
          ...
          <div className="flex md:flex-row flex-col gap-2">
            ...
            {state_management.map((sm) => {
              return (
                <span className="text-gray-400 md:px-1.5" key={sm}>
                  {sm}
                </span>
              );
            })}
          ...
          <div className="flex md:flex-row flex-col gap-2">
            ...
            {ui_libraries.map((ul) => {
              return (
                <span className="text-gray-400 md:px-1.5" key={ul}>
                  {ul}
                </span>
              );
            })}
          ...
          <div className="flex md:flex-row flex-col gap-2">
            ...
            {cloud.map((cloud) => {
              return (
                <span className="text-gray-400 md:px-1.5" key={cloud}>
                  {cloud}
                </span>
              );
            })}
